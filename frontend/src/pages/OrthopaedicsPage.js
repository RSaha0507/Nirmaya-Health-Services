// src/pages/OrthopaedicsPage.js
import React from 'react';
import { orthopaedicsData } from '../data/orthopaedics'; // Import the specific department data
import { ChevronRight, Bone } from 'lucide-react';

const OrthopaedicsPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = orthopaedicsData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Restoring Movement, Improving Lives</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Orthopaedic Surgeons</h2>
