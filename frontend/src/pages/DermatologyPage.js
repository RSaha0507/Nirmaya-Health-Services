// src/pages/DermatologyPage.js
import React from 'react';
import { dermatologyData } from '../data/dermatology'; // Import the specific department data
import { ChevronRight, Sparkles } from 'lucide-react';

const DermatologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = dermatologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Expert Care for Healthy Skin, Hair, and Nails</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Dermatologists</h2>
