// src/pages/NeurologyPage.js
import React from 'react';
import { neurologyData } from '../data/neurology'; // Import the specific department data
import { ChevronRight, BrainCircuit } from 'lucide-react';

const NeurologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = neurologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Excellence in Brain and Nerve Care</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Neurologists</h2>
