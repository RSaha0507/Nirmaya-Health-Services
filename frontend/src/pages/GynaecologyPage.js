// src/pages/GynaecologyPage.js
import React from 'react';
import { gynaecologyData } from '../data/gynaecology'; // Import the specific department data
import { ChevronRight, Baby } from 'lucide-react';

const GynaecologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = gynaecologyData;
    const departmentDoctors = doctors.filter(doc => doc.department === "Gynaecology & Obstetrics");
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Dedicated to Women's Health at Every Stage</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                <section className="mb-16">
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Conditions We Treat</h2>
                    <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                            {conditionsTreated.map(condition => (
                                <li key={condition} className="flex items-center text-gray-700 text-lg">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Gynaecologists & Obstetricians</h2>
                            ...
                            {departmentDoctors.map((doctor) => (
                                <div key={doctor.id} className="bg-white rounded-lg shadow-lg overflow-hidden text-center transform hover:-translate-y-2 transition-transform duration-300">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <button onClick={() => navigateTo('Appointments')} className="mt-4 bg-blue-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-700 transition duration-300">
                                            Book Appointment
                                        </button>
                                    </div>
                                </div>
