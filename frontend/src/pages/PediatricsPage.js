// src/pages/PediatricsPage.js
import React from 'react';
import { pediatricsData } from '../data/pediatrics'; // Import the specific department data
import { ChevronRight, ToyBrick } from 'lucide-react';

const PediatricsPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = pediatricsData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Nurturing the Health of Future Generations</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                            ...
                            <div key={spec.name} className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
                                <div className="flex items-center mb-3">
                                    <div className="bg-blue-100 p-2 rounded-full mr-4">
                                        <ToyBrick className="text-blue-600" />
                                    </div>
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Pediatricians</h2>
