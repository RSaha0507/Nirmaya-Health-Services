// src/pages/ImmunologyPage.js
import React from 'react';
import { immunologyData } from '../data/immunology'; // Import the specific department data
import { ChevronRight, Shield } from 'lucide-react';

const ImmunologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = immunologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Balancing and Strengthening Your Body's Defenses</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Immunologists</h2>
