// src/pages/UrologyPage.js
import React from 'react';
import { urologyData } from '../data/urology'; // Import the specific department data
import { ChevronRight, Droplet } from 'lucide-react';

const UrologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = urologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Comprehensive Urological Care</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Urologists</h2>
