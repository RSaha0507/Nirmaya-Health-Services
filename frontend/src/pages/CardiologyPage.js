// src/pages/CardiologyPage.js
import React from 'react';
import { cardiologyData } from '../data/cardiology'; // Import the specific department data
import { Stethoscope, ChevronRight, HeartPulse } from 'lucide-react';

const CardiologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = cardiologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Expert care for your heart</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Cardiologists</h2>
