// src/pages/GastroenterologyPage.js
import React from 'react';
import { gastroenterologyData } from '../data/gastroenterology'; // Import the specific department data
import { ChevronRight, Activity } from 'lucide-react';

const GastroenterologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = gastroenterologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Specialized Care for Your Digestive Health</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Gastroenterologists</h2>
