// src/pages/OncologyPage.js
import React from 'react';
import { oncologyData } from '../data/oncology'; // Import the specific department data
import { ChevronRight, Ribbon } from 'lucide-react';

const OncologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = oncologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Compassionate and Advanced Cancer Care</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                            ...
                            <div key={spec.name} className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
                                <div className="flex items-center mb-3">
                                    <div className="bg-blue-100 p-2 rounded-full mr-4">
                                        <Ribbon className="text-blue-600" />
                                    </div>
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Oncologists</h2>
