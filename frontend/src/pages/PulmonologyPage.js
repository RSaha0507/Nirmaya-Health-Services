// src/pages/PulmonologyPage.js
import React from 'react';
import { pulmonologyData } from '../data/pulmonology'; // Import the specific department data
import { ChevronRight, Wind } from 'lucide-react';

const PulmonologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = pulmonologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Expert Care for Your Respiratory Health</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Pulmonologists</h2>
