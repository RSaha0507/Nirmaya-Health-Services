// src/pages/NeurosurgeryPage.js
import React from 'react';
import { neurosurgeryData } from '../data/neurosurgery'; // Import the specific department data
import { ChevronRight, Brain } from 'lucide-react';

const NeurosurgeryPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = neurosurgeryData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Precision Surgical Care for the Nervous System</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Neurosurgeons</h2>
