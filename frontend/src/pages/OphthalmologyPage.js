// src/pages/OphthalmologyPage.js
import React from 'react';
import { ophthalmologyData } from '../data/ophthalmology'; // Import the specific department data
import { ChevronRight, Eye } from 'lucide-react';

const OphthalmologyPage = ({ doctors, navigateTo }) => {
    const { name, description, specialties, conditionsTreated, bannerImage } = ophthalmologyData;
        ...
        <div className="bg-gray-50">
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mt-2">Advanced Care for Your Vision</p>
                </div>
            </section>
            ...
            <div className="py-20 container mx-auto px-6">
                ...
                {/* Doctors Section */}
                <section>
                    <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Ophthalmologists</h2>
